  ...
  return (
    <nav className="flex items-center justify-between flex-wrap bg-blue-300 p-2">
      <div className="flex items-center flex-shrink-0 mr-6">
        ...
        >
          <span className="block xl: text-600 xl:inline" style={{ marginLeft: '0px' }}>AstroBharat </span>
        </a>
      </div>
      <form className="w-full max-w-sm p-2">
        <div className="flex items-center border-b-2 border-amber-900 py-2">
          <input
            className="appearance-none bg-transparent border-none placeholder-black w-full text-white mr-3 py-1 px-1 leading-tight focus:placeholder-black"
            type="text"
            placeholder="  Search"
            value={searchQuery}
